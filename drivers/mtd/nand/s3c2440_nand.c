/*
 * (C) Copyright 2013 Johnson Diao
 * Author: Johnson Diao <diaochengdong@gmail.com>
 * This file base on the s3c2410_nand.c,which author
 * is :
 *
				     ...
				     u_char *read_ecc, u_char *calc_ecc)
{
	...
	debug("s3c2440_nand_correct_data: not implemented\n");
	return -1;
}
#endif
...
int board_nand_init(struct nand_chip *nand)
{
	...
	/* initialize hardware */
        /* Modify if you change NAND JohnsonDiao */
	tacls = 4;
	twrph0 = 8;
	twrph1 = 8;
	...
	writel(readl(&nand_reg->nfcont) | cfg,
			&nand_reg->nfcont);
